        ...
        public ActionResult Initialize()
        {
            ...
            foreach (Type t in Assembly.GetExecutingAssembly().GetTypes())
            {
                ...
                if (t.Namespace == "Diploma.Controllers" && t.Name.Contains("Controller") && t.Name != "BaseController")
                {
                    ...
                    var entity = new DiplomaDb.Controller() { Name = entityName, CaptionEN = entityName };
                    ...
                    foreach (MethodInfo m in t.GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly))
                    {
                        ...
                        {
                            context.Actions.Add(new DiplomaDb.Action()
                            {
                                Name = m.Name,
                                Entity = entity,
                                CaptionEN = m.Name
            ...
            {
                CaptionEN = "Admin",
                DescriptionEN = "This is Mr.'A'!",
                CaptionRU = "Админ",
                DescriptionRU = "Властвует над всем!",
                CaptionUA = "Адмін",
                DescriptionUA = "Наймогутніший користувач у системі."
            };
            ...
            {
                CaptionEN = "Methodist",
                DescriptionEN = "He likes to accumulate knowledges.",
                CaptionRU = "Методист",
                DescriptionRU = "Наполняет систему знаниями.",
                CaptionUA = "Методист",
                DescriptionUA = "Наповнюэ систему знаннями."
            };
            Role role3 = new Role()
            {
                CaptionEN = "User",
                DescriptionEN = "Just user.",
                CaptionRU = "Пользователь",
                DescriptionRU = "Обладает найменьшей силой в системе.",
                CaptionUA = "Користувач",
                DescriptionUA = "Звичайний користувач."
            };
